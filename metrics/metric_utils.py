...
def compute_feature_stats_for_dataset(
    ...
    **stats_kwargs,
    ...
    _ = opts.dataset_kwargs.pop("class_name_evaluation", None)
    _ = opts.dataset_kwargs.pop("label_combination", None)
    dataset = dnnlib.util.construct_class_by_name(**opts.dataset_kwargs)
    ...
    for images, _labels in torch.utils.data.DataLoader(
        ...
        **data_loader_kwargs,
        ...
        if images.shape[1] > 3:
            ...
            images = images[:, middle_slice - 1 : middle_slice + 2, :, :]
...
def compute_feature_stats_for_generator(
    ...
    **stats_kwargs,
    ...
    opts = copy.deepcopy(opts)
    eval_cls = opts.dataset_kwargs.pop("class_name_evaluation", None)
    if eval_cls is not None:
        opts.dataset_kwargs["class_name"] = eval_cls
